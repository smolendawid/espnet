...
data_type = {'dev-clean' 'test-clean' 'dev-other' 'test-other' 'train-clean-100' 'train-clean-360' 'train-other-500'};
wsj0root = '/disks/sda1/dsmolen/'; % YOUR_PATH/, the folder containing wsj0/
%output_dir16k='/Users/user/agh/wav16k';
output_dir8k='/home/dsmolen/agh/LibriSpeech_wav8k';
...
%        status = mkdir([output_dir8k  '/' min_max{i_mm} '/' data_type{i_type} '/s2/']); %#ok<NASGU>
        ...
        Source1File = ['mix_2_spk_' min_max{i_mm} '_1'];
        Source2File = ['mix_2_spk_' min_max{i_mm} '_2'];
        MixFile     = ['mix_2_spk_' min_max{i_mm} '_mix'];
