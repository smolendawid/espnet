...
for file in utt2spk utt2lang utt2dur utt2num_frames reco2dur feats.scp text text_spk1 text_spk2 cmvn.scp vad.scp reco2file_and_channel wav.scp spk2gender $extra_files; do
